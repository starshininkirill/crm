...
@section('content')
    <h1 class="text-4xl font-semibold mb-6">Создать отдел</h1>
    <form method="POST" class=" max-w-md " action="{{ route('admin.department.store') }}">
        @if (session('success'))
        ...
        <div class="flex flex-col gap-2">
            <x-form-input type="text" name="name" placeholder="Название отдела" label="Название отдела" />
            <button type="submit"
